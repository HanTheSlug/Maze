         ...
         try {
            ...
            while(in.hasNext()){
                ...
                while(!unionS.isConnected(enter.getID(),exit.getID())){
                    ...
                    int other = randomAdjacentRoom(room);
                    //System.out.println(rand+","+other);
                    if(unionS.find(room)!=unionS.find(other)) {
                        unionS.join(room, other);
                        buildPathInMaze(room, other);
                    }}
             }
